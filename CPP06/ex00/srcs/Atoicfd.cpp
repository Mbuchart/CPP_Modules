...
bool Atoicfd::convertible(std::string a)
{
	...
	{
		_i = std::strtod(a.c_str(), NULL);// convertie std::string en int
		...
		{
			_f = std::strtod(a.c_str(), NULL);
			_d = static_cast<double>(_f);
		}
	}
	else if (check_double(a) == true || check_double_infnan(a) == true)
	{
		_d = std::atof(a.c_str());// convertie std::string en double
	...
	{
		_f = std::strtod(a.c_str(), NULL); // convertie std::string en double
